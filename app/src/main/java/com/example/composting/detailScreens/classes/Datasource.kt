...
class Datasource {
    fun load() : ArrayList<CompostItems>{
        ...
        dataList.add(CompostItems("Apple", CATEGORY_FOOD, 1))
        dataList.add(CompostItems("Broccoli", CATEGORY_FOOD, 2))
        dataList.add(CompostItems("Banana", CATEGORY_FOOD,1))
        dataList.add(CompostItems("Strawberry", CATEGORY_FOOD, 2))
        dataList.add(CompostItems("Bell Pepper", CATEGORY_FOOD, 1))
        dataList.add(CompostItems("Tomato", CATEGORY_FOOD, 3))
